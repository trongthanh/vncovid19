...
const svg = d3.select("#historicalChart")
    .append("svg")
...
d3.csv("./data/Vietnam.csv",
    (row, index, column) => {
        ...
        svg.append("g").attr("transform", "translate(0," + _height + ")").call(d3.axisBottom(x));

        // TODO: Add Y axis
        const y = d3.scaleLinear().domain([0, 280]).range([_height, 0]);
